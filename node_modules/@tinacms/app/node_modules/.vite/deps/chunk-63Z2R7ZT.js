...
async function importCodeMirror(addons, options) {
  const CodeMirror = await import("./codemirror.es-2ORGE3NW.js").then(function(n2) {
    return n2.c;
  }).then((c2) => typeof c2 === "function" ? c2 : c2.default);
  await Promise.all((options == null ? void 0 : options.useCommonAddons) === false ? addons : [
    import("./show-hint.es-ZLZD6UHO.js").then(function(n2) {
      return n2.s;
    }),
    import("./matchbrackets.es-ZDDMGPMF.js").then(function(n2) {
      return n2.m;
    }),
    import("./closebrackets.es-JJ7MORO4.js").then(function(n2) {
      return n2.c;
    }),
    import("./brace-fold.es-JDXX6LBI.js").then(function(n2) {
      return n2.b;
    }),
    import("./foldgutter.es-ATYEQ3KR.js").then(function(n2) {
      return n2.f;
    }),
    import("./lint.es3-MG5CSYYL.js").then(function(n2) {
      return n2.l;
    }),
    import("./searchcursor.es-RY5XOLFG.js").then(function(n2) {
      return n2.s;
    }),
    import("./jump-to-line.es-T4FMEP25.js").then(function(n2) {
      return n2.j;
    }),
    import("./dialog.es-4NVWSLCS.js").then(function(n2) {
      return n2.d;
    }),
    import("./sublime.es-6MW6R2GY.js").then(function(n2) {
      return n2.s;
    }),
    ...addons
  ]);
...
function useHeaderEditor({
  ...
  (0, import_react.useEffect)(() => {
    ...
    void importCodeMirror([
      import("./javascript.es-XTY6PSIE.js").then(function(n2) {
        return n2.j;
      })
    ]).then((CodeMirror) => {
      if (!isActive) {
...
function useQueryEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    void importCodeMirror([
      import("./comment.es-GJRUJSAF.js").then(function(n2) {
        return n2.c;
      }),
      import("./search.es-XCZAGWIM.js").then(function(n2) {
        return n2.s;
      }),
      import("./hint.es-N7R5ZSJE.js"),
      import("./lint.es-MOEQXJRF.js"),
      import("./info.es-DQ74SPOW.js"),
      import("./jump.es-RON5XPAS.js"),
      import("./mode.es-46OJF3JH.js")
    ]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
...
function useVariableEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    void importCodeMirror([
      import("./hint.es2-B6J6XZ5Y.js"),
      import("./lint.es2-PM3NAVBV.js"),
      import("./mode.es3-H3AC7V7G.js")
    ]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
...
function useResponseEditor({
  ...
  (0, import_react.useEffect)(() => {
    ...
    void importCodeMirror([
      ...
      import("./mode.es2-D6THGSSS.js"),
      import("./info-addon.es-XB76USD5.js")
    ], {
...
@graphiql/react/dist/index.es.js:
  ...
  ***************************************************************************** *)
   ...
   *)
*/
//# sourceMappingURL=chunk-63Z2R7ZT.js.map
